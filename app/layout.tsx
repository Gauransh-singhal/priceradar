...
export const metadata: Metadata = {
  title: "PriceRadar — Compare prices across 7 Indian platforms",
  description: "Compare prices across Amazon, Flipkart, BigBasket, Blinkit, JioMart, Croma, and Vijay Sales instantly.",
};
